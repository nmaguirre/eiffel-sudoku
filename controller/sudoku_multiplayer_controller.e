note
	description	: "{SUDOKU_MULTIPLAYER_CONTROLLER}.Receive a number from the GUI then sends it to model.board. Checks if sudoku is completed. Update the GUI when creating a board"
	author		: "A. Bruno Martinez"
	date		: "10/09/2013"
	revision	: "0.1"
...
feature  -- Initialization
	...
	set_model (first_model: MULTIPLAYER_STATE)
		require
	...
	get_controller: SUDOKU_MULTIPLAYER_CONTROLLER
...
feature {NONE} -- Implementation
	...
	the_instance: SUDOKU_MULTIPLAYER_CONTROLLER
...
feature {NONE} -- control of red cells
	...
	get_hint
	do
		--Informar al usuario que no puede utilizar pista
	end
